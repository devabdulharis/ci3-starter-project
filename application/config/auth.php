...
$config['auth_session_id'] = 'sistem_auth_id';
$config['auth_session_enkey'] = 'sistem_auth_enkey';
$config['auth_cookie_id'] = 'sistem_auth_id';
$config['auth_cookie_key'] = 'sistem_auth_key';
$config['auth_role_key'] = 'role';
